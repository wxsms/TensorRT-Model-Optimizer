...
"""Phi-MoE specs (HF model type ``phimoe``)."""

from ..specs import ModelSpec, MoESpec, register

__all__: list[str] = []

# Phi-MoE derives from Mixtral and inherits its w1/w2/w3 expert naming
# (PhimoeBlockSparseTop2MLP). transformers 5 replaces the per-expert ModuleList with a
# fused PhimoeExperts, which the structural first-projection check resolves instead --
...
# ``type(root_model).__name__.lower()`` and "phimoeforcausallm" matched none of its
